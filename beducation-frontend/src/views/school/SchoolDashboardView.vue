  ...
  <div class="space-y-6">
    <div class="flex flex-col md:flex-row justify-between items-start md:items-center p-6 bg-white rounded-2xl shadow-sm border border-slate-200">
      ...
      <div class="mt-4 md:mt-0 space-x-3 flex items-center">
        <button @click="$router.push('/school/profile/edit')" class="btn-secondary text-sm px-4 py-2 flex items-center gap-2">
...
<script setup>
/**
 * PANEL INSTITUCIONAL (Dashboard de Escuela)
 * ------------------------------------------
 * Centro de gestión para los coordinadores de centros educativos.
 * Funcionalidades clave:
 * 1. Gestión de Alumnado: Registro manual o importación masiva vía CSV.
 * 2. Seguimiento (Funnel): Monitorización del progreso de cada alumno (desde aplicación hasta convenio).
 * 3. Validaciones Finales: Firma digital (simulada) de los Learning Agreements (Etapa 5).
 * 4. Estadísticas: Resumen visual de la tasa de éxito de colocación.
 */
