  ...
  <div class="space-y-6">
    ...
    <div class="flex justify-between items-start md:items-center py-6 border-b border-slate-200">
        ...
        <div class="flex items-center gap-3">
            <button @click="$router.push('/company/profile/edit')" class="btn-secondary flex items-center gap-2 border-slate-200">
 ...
 * --------------------
 * Punto de control para las empresas que publican ofertas de prácticas.
 * Permite:
 * 1. Crear y editar vacantes (ERASMUS+ Placements).
 * 2. Visualizar el pipeline de candidatos por estado.
 * 3. Evaluar perfiles y gestionar el proceso de selección y auditoría global.
 */
